local options = {
  ...
  cmdheight = 2, -- more space in the eovim command line for displaying messages
  ...
  guifont = "JetBrains Mono Nerd Font:h13", -- the font used in graphical neovim applications
